...
public class DataSource {
    ...
    public FlightSearch fetchFlights() throws Exception {
        ...
        double costPerSeat = 6000.0;
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 195, costPerSeat));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 35, costPerSeat));
        travelClasses.add(new TravelClass(ClassType.FIRST, 8, costPerSeat));
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 144, costPerSeat));
        ...
        travelClasses = new ArrayList<>();
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 152, costPerSeat));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 20, costPerSeat));
