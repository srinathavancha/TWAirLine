...
public class FlightSearchTests {
    ...
    public void setUp() throws Exception {
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 30, costPerSeat));
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 5, costPerSeat));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 5, costPerSeat));
    ...
    @Test
    public void shouldReturnTotalCostPerBooking() throws Exception {
        int numberOfSeats = 2;
        FlightSearch matchingFlights = allFlights.byAvailableSeats(ClassType.ECONOMY, numberOfSeats);
        ResultFlight result = new ResultFlight(allFlights.getFlightList().get(0), ClassType.ECONOMY, numberOfSeats);
        Assert.assertEquals(costPerSeat * numberOfSeats, result.calculateCost(), 0.01);
    }
